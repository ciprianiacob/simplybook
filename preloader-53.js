...
function calculateDoHomeArtTimingStatistics() {
    ...
    try {
        ...
        domDoHomeArtContentLoadedPlusLoadSeconds = domContentLoadedTimeSeconds + loadTimeSeconds;
...
async function setDoHomeArtPreloaderStatus() {
    ...
    await calculateDoHomeArtTimingStatistics();
    var delayDoHomeArtValue = domDoHomeArtContentLoadedPlusLoadSeconds * 1000; // Convert seconds to milliseconds

    console.log("DELAY VALUE: ", delayDoHomeArtValue)
