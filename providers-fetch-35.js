                ...
                $(document).ready(function () {
                    $('#sb_booking_content .category-item').each(function () {
                        ...
                        if (categoryIdMatch) {
                          ...
                          // Verificare dacă categoryServices[0] există și are proprietatea 'providers'
                          if (categoryServices.length > 0 && categoryServices[0] && categoryServices[0].providers && categoryServices[0].providers.length === 1) {
