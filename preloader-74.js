...
function calculateDoHomeArtTimingStatistics() {
    try {
        ...
        setTimeout(setBeforePseudoElementBackground, domContentLoadedTime * 1000); // Convert seconds to milliseconds
    } catch (error) {
...
function setBeforePseudoElementBackground() {
    ...
    if (mainContentElement) {
        mainContentElement.style.setProperty('background-color', 'rgba(255,255,255,0.5)');
    } else {
