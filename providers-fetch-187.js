																...
																if (correspondingService) {
																	...
																	if (providerProp.attr('data-provider-availability-first-day') === "null") {
																		try {
																			...
																			var widgetIframes = document.querySelector('.sb-widget-iframe');
																			...
																			if (iframe.length > 0) {
																				...
																				// Draw the content of the target element on the canvas
																				...
																				// Create a new output element for each screenshot
																				...
																				// Append the output element to the main output container
