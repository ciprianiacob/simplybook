...
function handleMutation(mutationsList = [], observer = null) {
...
function observePreloader() {
    var observer = new MutationObserver(handleMutation);
    var targetNode = document.getElementById('preloader');
...
function handleProvidersFetchEvents() {
    clearLoadingClassTimeout();
    addLoadingClass();
    processData();
}

$(document).on('click hashchange', '.item__footer .btn.select, #sb_back_button a, .steps-nav li a', handleProvidersFetchEvents);
$(document).ready(handleProvidersFetchEvents);
$(window).on('load, hashchange', handleProvidersFetchEvents);
document.addEventListener('DOMContentLoaded', handleProvidersFetchEvents);
