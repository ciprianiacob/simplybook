        ...
        $(document).ready(function () {
            ...
            if (dynamicServiceId) {
                $('#sb_booking_content .category-item').each(async function (providerIndex) {
                    ...
                    await processCategoryItem($(this), dynamicServiceId, providers, services);
                });
...
async function processCategoryItem(categoryItem, dynamicServiceId, providers, services) {
                    ...
                    if (foundProvider) {
                        ...
                        if (correspondingService) {
                            ...
                            if (providerProp.attr('data-provider-availability-first-day') === "null") {
                                try {
                                    const constructedUrl = await constructURLOne(locationValue, providerId, dynamicServiceId);
