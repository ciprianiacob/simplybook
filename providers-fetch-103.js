	...
	try {
		...
		if (typeof $ !== 'undefined') {
			$(document).ready(function() {
				...
				var categoryItem = document.querySelector('#sb_booking_content .category-item');
				if (categoryItem) {
...
if (typeof $ !== 'undefined') {
	var processDataBtns = document.querySelector('.item__footer .btn.select, #sb_back_button a, .steps-nav li a');
	$(document).on('click', processDataBtns, function() {
		processData();
	})
};
