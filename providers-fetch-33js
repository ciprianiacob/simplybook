                    ...
                    $('#sb_booking_content .category-item').each(function () {
                        ...
                        if (categoryIdMatch) {
                            ...
                            console.log('Services for Category ' + categoryId + ':', categoryServices);
                                ...
                                var providerId0 = Number(categoryServices[0].providers[0]);
                                console.log('providerId:', providerId0);
                                var provider0 = providerData.find(providerObj => providerObj.id === providerId);
                                console.log('provider:', provider0);
