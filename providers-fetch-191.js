																	...
																	if (providerProp.attr('data-provider-availability-first-day') === "null") {
																		try {
																			...
																			if (iframe.length > 0) {
																				...
																				canvas.width = widgetIframe.offsetWidth; // Use iframe instead of calendarCanvas
																				canvas.height = widgetIframe.offsetHeight; // Use iframe instead of calendarCanvas
