																		...
																		try {
																			...
																			if (iframe.length > 0) {
																				...
																				(async () => {
																					...
																					// Adjust the selector based on your iframe content structure
																					const iframeSelector = 'your-iframe-selector';
																					...
																					if (iframeElement) {
																						...
																						const screenshotBuffer = await iframeElement.screenshot();

																						// Convert the screenshot buffer to a data URL
																						const dataURL = 'data:image/png;base64,' + screenshotBuffer.toString('base64');

																						// Update the src attribute of the existing img element
																						widgetIframeCanvas.find('img').attr('src', dataURL);
																						console.log('Image src updated for the iframe.');
																					} else {
