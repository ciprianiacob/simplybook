...
async function processData() {
    try {
        ...
        if (correspondingService) {
            ...
            var servicePrice = correspondingService.price; // Replace 'price' with the actual property name
            ...
            var priceElement = $(this).find('.price-item'); // Assuming this is the element where you want to display the price

            providerTitle.text(foundProvider.name);
            providerImage.attr('src', foundProvider.picture_path);
            priceElement.text('Price: ' + servicePrice); // Modify this line based on your HTML structure
        } else {
