						...
						$(document).ready(function() {
							$('#sb_booking_content .category-item').each(function() {
								...
								if (categoryIdMatch) {
									...
									console.log('Services Data:', JSON.stringify(serviceData, null, 2));
									console.log('Providers Data:', JSON.stringify(providerData, null, 2));
									console.log('Categories Data:', JSON.stringify(categoryData, null, 2));
