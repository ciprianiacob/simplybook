...
async function calculateDoHomeArtTimingStatistics() {
	try {
		...
		console.log("Countdown start at: ", startCountdown(Number((finalDelayDoHomeArtValue + 1).toFixed(0))));
...
async function setDoHomeArtPreloaderStatus() {
	...
	if (finalDelayDoHomeArtValue = 0) {
		...
		console.log("", finalDelayDoHomeArtValue);
	}
}
