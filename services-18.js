function filterServices() {
	(function() {
		...
		function displayErrorMessage() {
			...
			if (displayedItems.length === 0 && (quantityFilterValue >= quantityMin || quantityFilterValue <= quantityMax) || displayedItems.length === null && (quantityFilterValue >= quantityMin || quantityFilterValue <= quantityMax)) {
				checkBaseUnits.parentNode.querySelector('label').style.borderColor = "red";
				checkWallUnits.parentNode.querySelector('label').style.borderColor = "red";
				checkTowerUnits.parentNode.querySelector('label').style.borderColor = "red";
			} else {
				checkBaseUnits.parentNode.querySelector('label').style.borderColor = "#9cb38b";
				checkWallUnits.parentNode.querySelector('label').style.borderColor = "#9cb38b";
				checkTowerUnits.parentNode.querySelector('label').style.borderColor = "#9cb38b";
			}
