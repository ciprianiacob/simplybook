																	...
																	if (providerProp.attr('data-provider-availability-first-day') === "null") {
																		try {
																			...
																			if (widgetIframe.length > 0) {
																				...
																				canvas.width = widgetIframe.offsetWidth;
                                        console.log('canvas.width:', canvas.width);
																				canvas.height = widgetIframe.offsetHeight;
                                        console.log('canvas.height:', canvas.height);

																				var context = canvas.getContext('2d');

																				context.fillStyle = getComputedStyle(widgetIframe).backgroundColor;
																				context.fillRect(0, 0, canvas.width, canvas.height);
																				context.font = getComputedStyle(widgetIframe).font;
																				context.fillStyle = getComputedStyle(widgetIframe).color;
																				context.fillText(widgetIframe.innerText, 10, 20);
