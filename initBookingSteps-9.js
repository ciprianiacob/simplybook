async function initBookingSteps() {
  ...
  console.log("Delay value before: ", (finalDelayDoHomeArtValue + 100).toFixed(2));
  ...
  }, (finalDelayDoHomeArtValue + 100).toFixed(2));
  console.log("Delay value after: ", (finalDelayDoHomeArtValue + 100).toFixed(2));
}
