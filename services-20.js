function filterServices() {
	(function() {
		...
		function noUnitTypeChecked() {
			var noUnitTypeChecked = document.querySelector('.service-filter-units-type .form-units-type');
      if(noUnitTypeChecked){
        noUnitTypeChecked.style.borderColor = "red";
      }
		}

		function unitTypeChecked() {
			var unitTypeChecked = document.querySelector('.service-filter-units-type .form-units-type');
      if(noUnitTypeChecked){
        noUnitTypeChecked.style.borderColor = "#9cb38b";
      }
		}
