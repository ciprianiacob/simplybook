																...
																if (correspondingService) {
																	...
																	if (providerProp.attr('data-provider-availability-first-day') === "null") {
																		try {
																			...
																			calendarImage.setAttribute('alt', 'Calendar Image');
																			calendarImage.setAttribute('class', 'calendar-image');
																			canvasCalendar.append(calendarImage);
																			if (iframe.length > 0) {
																				...
																				calendarImage.setAttribute('src', iframeSrc);
