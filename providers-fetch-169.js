(function() {
    ...
    if (iframe.length > 0) {
        ...
        try {
            const html2canvasModule = await import('https://cdn.jsdelivr.net/npm/html2canvas@1.0.0-rc.5/dist/html2canvas.esm.js');
            ...
            if (calendarCanvas.length > 0) {
                try {
                    ...
                    html2canvasModule.default(iframe[0]).then(function (canvas) {
