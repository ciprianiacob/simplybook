...
if (iframe.length > 0) {
    ...
    captureIframe.onload = function () {
        // Create a temporary div and append the iframe content
        const tempDiv = document.createElement('div');
        tempDiv.innerHTML = captureIframe.contentDocument.documentElement.outerHTML;
        document.body.appendChild(tempDiv);

        // Draw the iframe content onto the calendarCanvas
        const canvasContext = calendarCanvas.getContext('2d');
        canvasContext.drawImage(tempDiv, 0, 0, calendarCanvas.width, calendarCanvas.height);
