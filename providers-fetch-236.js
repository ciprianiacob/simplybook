(function() {
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const clonedContents = iframeDocument.cloneNode(true);

            // Create a new iframe element and set its content to the cloned document
            const clonedIframe = document.createElement('iframe');
            clonedIframe.srcdoc = clonedContents.documentElement.outerHTML;

            // Append the cloned iframe to the container
            canvasContainer.empty().append(clonedIframe);

            console.log("Cloned iframe appended to the container.");
