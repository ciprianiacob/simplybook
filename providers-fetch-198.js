										...
										async function processCategoryItem() {
                                          ...
                                          console.log("widgetIframeCanvas.length: ", widgetIframeCanvas.length);
                                            ...
                                            var calendarCanvas = $(this);
																						...
																						canvas.width = calendarCanvas.offsetWidth;
																						console.log('canvas.width:', canvas.width);
																						canvas.height = calendarCanvas.offsetHeight;
																						console.log('canvas.height:', canvas.height);

																						var context = canvas.getContext('2d');

																						context.fillStyle = getComputedStyle(calendarCanvas).backgroundColor;
																						context.fillRect(0, 0, canvas.width, canvas.height);
																						context.font = getComputedStyle(calendarCanvas).font;
																						context.fillStyle = getComputedStyle(calendarCanvas).color;
																						context.fillText(calendarCanvas.innerText, 10, 20);
