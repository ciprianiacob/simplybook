                                ...
                                for (const providerId of service.providers) {
                                    ...
                                    if (foundProvider) {
                                        ...
                                        if (correspondingService) {
                                            ...
                                            // Use the dynamically identified service ID
                                            var constructedURLOne = constructURLOne(location, categoryId, dynamicServiceId, 'count_value', 'addons_value', providerId, 'date_value');

                                            console.log("Constructed URL for dynamic service:", constructedURLOne);

                                            providerProp.attr('data-provider-availability-first-day', constructedURLOne);
                                        } else {
