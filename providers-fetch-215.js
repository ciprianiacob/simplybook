  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      domtoimage.toPng(iframeDocument.body).then((dataURL) => {
        ...
        // Check if canvasContainer is a valid DOM element
        if (canvasContainer && typeof canvasContainer.appendChild === 'function') {
          ...
          console.error("canvasContainer is not a valid DOM element:", canvasContainer);
