...
async function processData() {
        ...
        $(document).ready(function () {
          ...
          if (dynamicServiceId) {
            $('#sb_booking_content .category-item').each(async function (providerIndex) {
                ...
                var constructURLOne = function(location, provider, service, count, date) {
    ...
    return url;
                ...
                // Fetch JSON response
                var response = await fetch(constructedUrl);
                var jsonResponse = await response.json();

                // Extract date from JSON response
                var firstWorkDay = jsonResponse.date;

                // Log Constructed URL and First work day
                console.log("Constructed URL:", constructedUrl);
                console.log("First work day for provider:", foundProvider.name, firstWorkDay);

                // Set data-provider-availability-first-day attribute
