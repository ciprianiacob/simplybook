	...
	(function() {
		async function setPreloaderStatus() {
			delay(200).then(function() {
				...
				if (isRunning) {
					targetElement.classList.add("content-is-not-loading");
				} else {
					targetElement.classList.remove("content-is-not-loading");
				}
			});
		}
		...
		async function processData() {
			try {
				...
				$(document).ready(function() {
					...
					const targetCommonName = "Pre-installation of 2 base units";
															...
															for (const providerId of service.providers) {
																...
																if (foundProvider) {
																	...
																	if (correspondingService) {
																		...
																		categoryItem.attr('data-loaded', true);
