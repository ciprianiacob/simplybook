function filterServices() {
    ...
    if(checkBaseUnits){checkBaseUnits.addEventListener('change', filterItems)}
    if(checkWallUnits){checkWallUnits.addEventListener('change', filterItems)}
    if(checkTowerUnits){checkTowerUnits.addEventListener('change', filterItems)}
    if(serviceQuantityFilter){serviceQuantityFilter.addEventListener('input', filterItems)}
