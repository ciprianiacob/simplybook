                                ...
                                for (const providerId of service.providers) {
                                    ...
                                    if (foundProvider) {
                                        ...
                                        if (correspondingService) {
                                            ...
                                            if (!providerProp.attr('data-provider-availability-first-day')) {
                                                var firstWorkDay = await constructURLOne(location, providerId, dynamicServiceId, 'count_value', 'date_value');
                                                ...
                                                providerProp.attr('data-provider-first-day-found', 'true');
                                            }
