  ...
  async function takeScreenshotAndAppend(iframe, canvasContainer) {
        return new Promise(async (resolve, reject) => {
            try {
                ...
                domtoimage.toPng(iframeDocument.body).then((dataURL) => {
    ...
    // Replace 'YOUR_BASE_URL' and 'YOUR_FONTAWESOME_URL' with the actual base URLs
    const baseFontUrl = 'https://dohomeart.co.uk/v2/themes/assets/fonts/';
    const fontAwesomeUrl = 'https://dohomeart.co.uk/v2/lib/font-awesome-5.13.0/webfonts/';

    // Update the font URLs in your code
    // For example:
    const caveaRegularUrl = baseFontUrl + 'Caveat-Regular.otf';
    const caveaBoldUrl = baseFontUrl + 'Caveat-Bold.otf';
    const questrialRegularUrl = baseFontUrl + 'Questrial-Regular.otf';
    const pacificoRegularUrl = baseFontUrl + 'Pacifico-Regular.otf';

    // Additional font URLs from font-awesome
    const fontAwesomeUrl1 = fontAwesomeUrl + 'font-awesome-icon-1.ttf';
    const fontAwesomeUrl2 = fontAwesomeUrl + 'font-awesome-icon-2.ttf';
