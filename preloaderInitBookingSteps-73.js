...
function trackPageResources() {
    ...
    resources.forEach(function(resource) {
        if (resource.complete) {
            loadedResources++;
            console.log('Resource already complete:', resource);
            calculateLoadingPercentage(); // Update the loading percentage
        } else {
            console.log('Adding load event listener for resource:', resource);
