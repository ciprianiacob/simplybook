            ...
            .then(serviceData => {
                $(document).ready(function () {
                    $('#sb_booking_content .category-item').each(function () {
                        ...
                        // Extrage providerIndex din serviciile care corespund categoriei curente și au un singur provider
                        ...
                        var providerIndex = providerData.findIndex(provider => provider.id === serviceForCategory.providers[0]);
